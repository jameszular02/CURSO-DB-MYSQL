...
se completara el menu principal con un CASE en un WHILE
12/08/2026
***** 
...
def insertar_cliente():
    ...
    nombre = valletras(nom)
    apape = input('Ingrese el primer apellido del cliente: ')
    pape = valletras(apape)
    asape = input('Ingrese el segundo apellido del cliente: ')
    sape = valletras(asape)
    ...
    while continuar:
        ...
        match opc1: 
            ...
            case '5':
                borrar_cliente
            case '6':
                cnn.close() #cierra la conexion de la base de datos
                break         
            case _:
